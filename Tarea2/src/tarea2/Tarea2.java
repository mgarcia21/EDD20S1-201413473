...
public class Tarea2 {
    ...
    public static void main(String[] args) {
        ...
        Menu();
                   ...
                   break;
                case 3:
                   System.out.println("Ingresa codigo de usuario que enviara fondos, pueden ser (1000,1001,1002,1003,1004):");
                   codCliente = sn.nextInt();                   
                   switch(codCliente){
                       case 1000:
                         System.out.println("Selecctionar a quien se le enviaran los fondos, pueden ser (1001,1002,1003,1004):");
                         codCliente = sn.nextInt();                   
                         switch(codCliente){
                                    case 1001:
                                    System.out.println("Ingresa el valor a transferir a la cuenta 1001");
                         ...
                         break;
                       case 1001:
                         System.out.println("Selecctionar a quien se le enviaran los fondos, pueden ser (1000,1002,1003,1004):");
                         codCliente = sn.nextInt();                   
                         switch(codCliente){
                                    case 1000:
                                    System.out.println("Ingresa el valor a transferir a la cuenta 1000");
                       ...
                       case 1002:
                         ...
                         break;
                       case 1003:
                         System.out.println("Selecctionar a quien se le enviaran los fondos, pueden ser (1001,1002,1000,1004):");
                         codCliente = sn.nextInt();                   
                         switch(codCliente){
                                    case 1000:
                                    System.out.println("Ingresa el valor a transferir a la cuenta 1000");
                       ...
                       case 1004:
                         System.out.println("Selecctionar a quien se le enviaran los fondos, pueden ser (1000,1002,1003,1001):");
                         codCliente = sn.nextInt();                   
                         switch(codCliente){
                                    case 1000:
                                    System.out.println("Ingresa el valor a transferir a la cuenta 1000");
